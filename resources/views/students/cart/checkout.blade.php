        ...
        <section class="max-w-5xl m-auto md:flex">
            ...
            <div>
                ...
                @if($admin->bank_account)
                    ...
                    <p class="mt-4">Pour plus de facilité, <a class="underline"
                                                              href="{{route('users.edit',$user->name)}}">Ajouter
                            votre numéro de compte dans les paramètres</a> ou <a class="underline"
                                                                                 href="mailto:{{$admin->email}}">transmettez-lui
                            votre numéro de compte via mail</a> @endif
                    </p>
                @else
                    <p>
                        Merci de prendre contact avec M. Spirlet, ou <a class="underline"
                                                                        href="mailto:{{$admin->email}}">lui envoyez un
                            mail</a>
                    </p>
                @endif
