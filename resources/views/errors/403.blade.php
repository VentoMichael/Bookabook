...
@section('content')
    <section class="flex justify-center flex-col items-center">
        <svg version="1.1" class="mb-6" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
...
<style type="text/css">
	...
	h324.4c16.8,0,30.4,13.6,30.4,30.4V245.8z"/>
        ...
        <p>
            Oops, cet accès est interdis ! <a href="/" class="underline">Je retourne à la page d'accueil</a>
        </p>
    </section>
@endsection
