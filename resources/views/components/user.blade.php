                        ...
                        <div class="mb-4 mt-10 text-center">
                            <div>
                                <a class="rounded-xl block mt-8 bg-orange-900 text-white p-3"
                                   href="{{route('users.show',['user'=>$user->name])}}">Plus d'informations sur <span>{{$user->name}}</span></a>
                            </div>
                        </div>
                    </section>
                @endforeach
    ...
    @endif
    <nav role="navigation" aria-label="Navigation pour accéder à des livres en particuliers">
