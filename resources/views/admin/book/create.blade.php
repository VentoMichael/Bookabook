...
@section('content')
    <div class="relative">
        ...
        <form aria-label="Edition d'un livre" role="form" method="POST" action="{{route('books.index')}}" class="sm:gap-12 sm:grid sm:grid-cols-2"
            ...
            <div class="field my-6 flex flex-col">
                ...
                <button role="button" name="publish" class="w-full rounded-xl mt-6 bg-orange-900 text-white p-3" type="submit">Créer
                    un nouveau livre
                </button>
        </form>
    </div>
